...
class TestCronTriggerProcessor:
    ...
    def setup_method(self):
        ...
        self.mock_services.trigger_repository = AsyncMock()
        self.mock_services.session_service = AsyncMock()
    ...
    async def test_process_trigger_only_once_per_minute_first_time(self):
    ...
    async def test_process_trigger_only_once_per_minute_already_fired(self):
    ...
    async def test_process_trigger_only_once_per_minute_next_minute(self):
    ...
    async def test_process_trigger_updates_last_triggered_on_success(self):
        ...
        assert result is True
        self.mock_services.trigger_repository.update.assert_called_once()
    ...
    async def test_process_trigger_multiple_calls_same_minute(self):
        ...
        async def mock_create_session_side_effect(*args, **kwargs):
